  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card-hover': '0 5px 10px rgba(0, 0, 0, 0.08), 0 30px 60px -20px rgba(0, 0, 0, 0.15)',
      },
      backdropBlur: {
        xs: '2px',
      },
      ...
      backgroundImage: {
        ...
        'grid-pattern-lg': 'linear-gradient(rgba(255,255,255,0.05) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,0.05) 1px, transparent 1px)',
        'blueprint': `
      ...
      backgroundSize: {
        'grid': '50px 50px',
        'grid-sm': '20px 20px',
        'blueprint': '100px 100px, 100px 100px, 20px 20px, 20px 20px',
      },
    },
  },
  plugins: [],
